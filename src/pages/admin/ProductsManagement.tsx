                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {product.is_featured ? (
                            <DropdownMenuItem
                              onClick={() => updateProductMutation.mutate({ productId: product.id, updates: { is_featured: false } })}
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() => updateProductMutation.mutate({ productId: product.id, updates: { is_featured: true } })}
                            >
                          ...
                          {product.is_active ? (
                            <DropdownMenuItem
                              onClick={() => updateProductMutation.mutate({ productId: product.id, updates: { is_active: false } })}
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() => updateProductMutation.mutate({ productId: product.id, updates: { is_active: true } })}
                            >
